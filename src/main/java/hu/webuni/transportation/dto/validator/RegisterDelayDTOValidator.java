...
public class RegisterDelayDTOValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (request.getMilestoneId() == null || !transportService.checkifMilestoneExits((request).getMilestoneId())){
        ...
        if (!transportService.checkIfTransportPlanExists(request.getMilestoneId(), request.getTransportPlanId())){
